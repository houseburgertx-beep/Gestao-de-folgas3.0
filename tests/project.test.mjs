...
test("o aplicativo possui manifesto, ícones e service worker seguros", async () => {
  ...
  assert.equal(manifest.start_url, "./?source=pwa&v=6.3.4");
  ...
  assert.match(serviceWorker, /house-folgas-v6\.3\.4/);
  ...
  assert.match(
    interfaceHtml,
    /rel="manifest" href="\.\/manifest\.webmanifest\?v=6\.3\.4"/,
  );
...
test("o login aguarda o Firebase e nunca orienta abrir o Apps Script", async () => {
  ...
  assert.match(builder, /main\.js\?v=6\.3\.4/);
